...
sudo phddns restart >>/home/pi/work/camre_capture_by_frame/log/login.txt
cd /home/pi/work/nat123
sudo mono  nat123linux.sh service >> /home/pi/work/camre_capture_by_frame/log/login.txt & 
